...
class TabQAgent(object):
    ...
    def act(self, world_state, agent_host, current_r, enemy_state, enemy):
        ...
        enemyYaw = yaw - 180#-180 * math.atan2(self.playerX - self.enemyX, self.playerZ - self.enemyZ) / math.pi
        ...
        enemyDifference = enemyYaw - self.enemyYaw
